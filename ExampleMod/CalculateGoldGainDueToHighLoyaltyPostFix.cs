...
namespace ExampleMod
{
    ...
    public static class CalculateGoldGainDueToHighLoyaltyPostFix
    {
        ...
        {
            // Current bonus per point of loyalty above 75 is about 1% per point. This increases that 8-fold, giving much higher bonuses if maintaining high loyalty
            explainedNumber.AddFactor(8.0f);
            float num = MBMath.Map(town.Loyalty, 75f, 100f, 0f, 20f);
            explainedNumber.AddFactor((float)num * 0.08f);
        }
    }
}
